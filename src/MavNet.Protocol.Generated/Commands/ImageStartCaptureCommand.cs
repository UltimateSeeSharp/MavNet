...
/// <para>MAV_CMD entry: <c>MAV_CMD_IMAGE_START_CAPTURE</c> (value 2000).</para>
/// </summary>
public readonly record struct ImageStartCaptureCommand(
    ...
    float Param7)
{
    public const uint CommandId = 2000u;
    public const string CommandName = "MAV_CMD_IMAGE_START_CAPTURE";
    ...
    public void PackParams(System.Span<float> target)
    {
        ...
        target[1] = Interval;
        target[2] = TotalImages;
        target[3] = SequenceNumber;
        target[4] = Param5;
        target[5] = Param6;
        target[6] = Param7;
    }
    ...
    public static ImageStartCaptureCommand Unpack(System.ReadOnlySpan<float> source) => new(
        source[0],
        source[1],
        source[2],
        source[3],
